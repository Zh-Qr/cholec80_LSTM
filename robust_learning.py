...
save_name = config['paths']['save_robustLSTM_weight']
...
if __name__ == '__main__':
    ...
    train_loaders = [DataLoader(ds, batch_size=64, shuffle=True, num_workers=4) for ds in train_datasets]
    test_loaders = [DataLoader(ds, batch_size=64, shuffle=True, num_workers=4) for ds in test_datasets]
