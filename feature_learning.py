...
save_name = config['paths']['save_notool_LSTM_weight']
...
if __name__ == '__main__':
    ...
    # 加载模型
    lstm_model = LSTMModel(input_size=2048, hidden_size=512, num_layers=2, num_classes=7)
